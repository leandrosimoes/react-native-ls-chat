...
describe('Controls tests', () => {
    ...
    it('Should Controls component render properly', () => {
        ...
        const controls = queryByLabelText(ControlsA11yLabel)
    ...
    it('Should Delete button NOT render if message user is NOT the same as the logged user', () => {
        ...
        const deleteButton = queryByLabelText(DeleteControlsA11yLabel)
    ...
    it('Should Reply button NOT render if message prop "isDelivered" === false', () => {
        ...
        const replyButton = queryByLabelText(ReplyControlsA11yLabel)
    ...
    it('Should onPressControlBody be triggered properly if body overlay is pressed', async () => {
        const { queryByLabelText } = render(
            <Controls
                user={mockUser}
                message={mockMessage}
        ...
        const overlayButton = queryByLabelText(ControlsA11yLabel)!
